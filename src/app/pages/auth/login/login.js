            ...
            <div >
                ...
                <div className="container-login100" >
                    <div className="login100-more"  >
                        <img src={Login} alt="login" style={{ position: "relative",   height:648, weight: 500}} />
                    </div>
                    
                    <div className="wrap-login100 p-l-50 p-r-50 p-t-120"  >
                        <form  >
                            <Grid item lg={12} style={{height: "610px"}} style={{backgroundColor:"#ffffff"}}>
                                ...
                                <div >
                                       <input className="input100" type="text" name="username" placeholder="Masukkan email Anda" />
                                </div>
                            ...
                            <div className="container-login100-form-btn" style={{ paddingTop: "40px"}}>
                         ...
                         <div className = "Masukmenggunakan"  >
                           ...
                           <div className="container-login100-form-btn1" >
                            ...
                            <div className="container-login100-form-btn1 ">
                                <div className="wrap-login100-form-btn" style={{ margin: 'auto' }}>
                                <div className="login100-form-bgbtn" style={{ backgroundColor: blue[800]  }}>
                            ...
                            <div className="container-login100-form-btn1" >
                                <div className="wrap-login100-form-btn" style={{ margin: 'auto' }}>
                                <div className="login100-form-bgbtn" style={{ backgroundColor: blue[700]  }}>
